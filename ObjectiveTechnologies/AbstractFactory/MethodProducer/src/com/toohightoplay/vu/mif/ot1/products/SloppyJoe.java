...
public class SloppyJoe implements Meal {
    ...
    public void revealTheTruth() {
    	...
    	System.out.println("Burger contains not so much but not so less E621, the Mighty Taste of All Time. It equals " 
    			+ (_E621 * randomGenerator.nextInt()) + " milligrams of goodness. :)");
    }
}
